...
**Problem:** [1612A-Distance](https://codeforces.com/contest/1612/problem/A)
...
-  otherwise, print two non-negative integers not exceeding 10⁶ — the coordinates of point C meeting the constraints. If there are multiple answers, print any of them. It can be shown that if any such point exists, it's possible to find a point with coordinates not exceeding 10⁶ that meets the constraints.
